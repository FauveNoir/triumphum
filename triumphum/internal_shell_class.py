...
def internalShellbindMakeDonationFunction(shellInput):
    # Fonction intermédiaire d’activation du procéssus de don
...
def internalShellLayoutFunction(shellInput):
    # Fonction de basculement de disposition de clavier

    # TODO utiliser la fonction factorisée <- 2026-03-08: Comment ?
...
def setInternalShellCommands():
    # Initialisation des commandes interrieures
